...
\fancyfoot[LO, RE]{\bfseries\scriptsize Generováno programem Doxygen }
}
%
...
\vspace*{7cm}
\begin{center}%
{\Large Rogalo Calculator \\[1ex]\large 1.\+0 }\\
\vspace*{1cm}
{\large Generováno programem Doxygen 1.9.1}\\
\end{center}
\end{titlepage}
...
\input{arguments__parser_8cpp}
\input{arguments__parser_8h}
\input{doctests_8cpp}
\input{main_8cpp}
